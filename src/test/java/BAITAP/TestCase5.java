...
public class TestCase5 {
    public static void testCase5() {
        ...
        createAccount.click();
        String email = "luutrieuvi200321@gmail.com";

        RegisterPage registerFill = new RegisterPage(driver);
        registerFill.enterFirstName("Luu");
        registerFill.enterMiddleName("Trieu");
        registerFill.enterLastName("Vi");
        registerFill.enterEmail(email);
        registerFill.enterPassword("123456");
        registerFill.enterConfirmPass("123456");
